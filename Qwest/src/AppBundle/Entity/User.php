...
class User
{
    ...
    */
     ...
     * @return User
     */
    public function addPasserelle(\AppBundle\Entity\Passerelle $passerelle)
    {
     ...
     * @param \AppBundle\Entity\Passerelle $passerelle
     */
    public function removePasserelle(\AppBundle\Entity\Passerelle $passerelle)
    {
        $this->passerelle->removeElement($passerelle);
    }
